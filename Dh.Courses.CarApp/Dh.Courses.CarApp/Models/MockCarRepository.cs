    ...
    public class MockCarRepository : ICarRepository
    {
        ...
        private void LoadCars()
        {
            cars = new List<Car>
            {
                ...
                new Car {id=2, Company="Audi", Model="A4", ProductionYear=2016, Mileage=106000, Capacity=4900, FuelType="gas", Description="Short and simple description", ImageURL="images/fordmustang.jpg", Power = 200, Price = 160000, IsCarOfTheWeek=true, ThumbnailURL="images/a4.jpg"},
